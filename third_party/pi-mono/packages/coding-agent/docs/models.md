...
Add custom providers and models (Ollama, vLLM, LM Studio, proxies) via `~/.rin/models.json`.
...
| `reasoningEffortMap` | Map rin thinking levels to provider-specific `reasoning_effort` values |
