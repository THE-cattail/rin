...
All keyboard shortcuts can be customized via `~/.rin/keybindings.json`. Each action can be bound to one or more keys.
...
| Action | Default | Description |
|--------|---------|-------------|
| `newLine` | `shift+enter`, `ctrl+j` | Insert new line |
