 ...
 *
 * Usage: pi --extension ./examples/pi/extensions/overlay-qa-tests.ts
 *
 * Commands:
	...
	private startProcess(): void {
		...
		this.proc = spawn("bash", [
			...
			for i in $(seq 1 100); do
				...
				DIR="${HOME}/demo-project/packages/coding-agent/src/modes/interactive"
				...
				if [ $((i % 5)) -eq 0 ]; then
					echo -e "  \\033[32m✓ Successfully processed \${i} files in ${HOME}/demo-project\\033[0m"
				fi
				if [ $((i % 7)) -eq 0 ]; then
