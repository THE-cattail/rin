...
ln -sf "$(pwd)/packages/coding-agent/examples/extensions/subagent/index.ts" ~/.rin/extensions/subagent/index.ts
ln -sf "$(pwd)/packages/coding-agent/examples/extensions/subagent/agents.ts" ~/.rin/extensions/subagent/agents.ts
